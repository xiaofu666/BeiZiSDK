Pod::Spec.new do |s|
    s.name             = 'SFBeiZiSDK'
    s.version          = '4.90.1.43'
    s.summary          = 'SFBeiZiSDK'

    s.description      = <<-DESC
            'SFBeiZiSDK is a AD SDK'
                       DESC

    s.homepage         = 'https://github.com/xiaofu666/BeiZiSDK'
    s.license      = { :type => "MIT", :file => "LICENSE" }
    s.author       = { "小富" => "3290235031@qq.com" }
    s.source       = { :git => 'https://github.com/xiaofu666/BeiZiSDK.git', :tag => s.version.to_s }
    ...
    s.vendored_frameworks = 'BeiZiFoundation.framework', 'BeiZiSDK.framework'
